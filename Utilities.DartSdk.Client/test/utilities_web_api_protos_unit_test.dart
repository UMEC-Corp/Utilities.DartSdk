...
void main() {
  ...
  group(UtilitiesWebApiProtosUnit, () {
    ...
    // bool isInAlert
    test('to test the property `isInAlert`', () async {
      // TODO
    });
    ...
    // Device serial
    // String deviceSerial
    test('to test the property `deviceSerial`', () async {
      // TODO
    });

    // Device MacAddress
    // String deviceMacAddress
    test('to test the property `deviceMacAddress`', () async {
      // TODO
    });
    ...
    test('to test the property `maintainerRole`', () async {
      // TODO
    });

    // Shows that the device is maintained by the current user
    // bool isMaintainedByMe
    test('to test the property `isMaintainedByMe`', () async {
      // TODO
    });

    // Shows that the device was manufactured by the current user
    // bool isManufacturedByMe
    test('to test the property `isManufacturedByMe`', () async {
      // TODO
    });

    // Firmware version available for update
    // String availableFirmwareVersion
    test('to test the property `availableFirmwareVersion`', () async {
      // TODO
    });

    // Url of newer firmware version
    // String availableFirmwareUrl
    test('to test the property `availableFirmwareUrl`', () async {
      // TODO
    });

    // Tiestamp of update startying date
    // int firmwareUpdateStarted
    test('to test the property `firmwareUpdateStarted`', () async {
      // TODO
    });

    // String ipv4Address
    test('to test the property `ipv4Address`', () async {
      // TODO
    });

    // String ipv4PublicAddress
    test('to test the property `ipv4PublicAddress`', () async {
      // TODO
    });

    // The model of the device unit.
    // String modelCode
    test('to test the property `modelCode`', () async {
      // TODO
    });

    // The firmware version of the unit.
    // String installedFirmwareVersion
    test('to test the property `installedFirmwareVersion`', () async {
      // TODO
    });
