...
// tests for UtilitiesWebApiProtosEventType
void main() {
  // final instance = UtilitiesWebApiProtosEventType();

  group('test UtilitiesWebApiProtosEventType', () {
    ...
    test('to test the property `eventClass`', () async {
      // TODO
    });
    ...
    // Name of the sensor
    // String sensorName
    test('to test the property `sensorName`', () async {
      // TODO
    });
  });
}
