...
// tests for UtilitiesWebApiProtosUpdateEventTypeRequest
void main() {
  // final instance = UtilitiesWebApiProtosUpdateEventTypeRequest();

  group('test UtilitiesWebApiProtosUpdateEventTypeRequest', () {
