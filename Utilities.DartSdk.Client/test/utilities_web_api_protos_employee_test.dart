...
// tests for UtilitiesWebApiProtosEmployee
void main() {
  // final instance = UtilitiesWebApiProtosEmployee();

  group('test UtilitiesWebApiProtosEmployee', () {
    ...
    test('to test the property `roleSystemName`', () async {
      // TODO
    });
  });
}
