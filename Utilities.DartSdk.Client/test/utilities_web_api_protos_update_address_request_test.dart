...
// tests for UtilitiesWebApiProtosUpdateAddressRequest
void main() {
  // final instance = UtilitiesWebApiProtosUpdateAddressRequest();

  group('test UtilitiesWebApiProtosUpdateAddressRequest', () {
