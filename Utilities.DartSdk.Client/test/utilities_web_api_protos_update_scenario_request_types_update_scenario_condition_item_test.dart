...
// tests for UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioConditionItem
void main() {
  // final instance = UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioConditionItem();

  group(
      'test UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioConditionItem',
      () {
    // Id of the action
    // String id
