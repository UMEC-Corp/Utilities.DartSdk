...
// tests for UtilitiesWebApiProtosAttachDeviceRequest
void main() {
  final instance = UtilitiesWebApiProtosAttachDeviceRequestBuilder();
  // TODO add properties to the builder and call build()

  group(UtilitiesWebApiProtosAttachDeviceRequest, () {
