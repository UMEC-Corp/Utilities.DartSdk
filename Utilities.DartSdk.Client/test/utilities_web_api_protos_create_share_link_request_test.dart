...
// tests for UtilitiesWebApiProtosCreateShareLinkRequest
void main() {
  // final instance = UtilitiesWebApiProtosCreateShareLinkRequest();

  group('test UtilitiesWebApiProtosCreateShareLinkRequest', () {
