...
// tests for UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioActionItem
void main() {
  // final instance = UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioActionItem();

  group(
      'test UtilitiesWebApiProtosUpdateScenarioRequestTypesUpdateScenarioActionItem',
      () {
    // Id of the action
    // String id
    ...
    test('to test the property `argument1`', () async {
      // TODO
    });

    // UtilitiesWebApiProtosScenarioActionArgument argument2
    test('to test the property `argument2`', () async {
      // TODO
    });
