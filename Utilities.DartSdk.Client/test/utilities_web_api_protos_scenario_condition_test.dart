...
// tests for UtilitiesWebApiProtosScenarioCondition
void main() {
  final instance = UtilitiesWebApiProtosScenarioConditionBuilder();
  // TODO add properties to the builder and call build()

  group(UtilitiesWebApiProtosScenarioCondition, () {
    // Id of the action
    // String id
    ...
    // String unitCode
    test('to test the property `unitCode`', () async {
      // TODO
    });

    // Code of the sensor
    // String sensorCode
    test('to test the property `sensorCode`', () async {
      // TODO
    });
    ...
    test('to test the property `targetDeviceModel`', () async {
      // TODO
    });

    // Name of the target device
    // String targetDeviceName
    test('to test the property `targetDeviceName`', () async {
      // TODO
    });
    ...
    test('to test the property `sourceDeviceId`', () async {
      // TODO
    });

    // Code of the virtual device to get value from
    // String sourceUnitCode
    test('to test the property `sourceUnitCode`', () async {
      // TODO
    });

    // Code of the sensor to get value from
    // String sourceSensorCode
    test('to test the property `sourceSensorCode`', () async {
      // TODO
    });

    // Code of the parameter to get value from
    // String sourceParameterCode
    test('to test the property `sourceParameterCode`', () async {
      // TODO
    });

    // Model of the source device
    // String sourceDeviceModel
    test('to test the property `sourceDeviceModel`', () async {
      // TODO
    });

    // Name of the source device
    // String sourceDeviceName
    test('to test the property `sourceDeviceName`', () async {
      // TODO
    });

    // Serial of the source device
    // String sourceDeviceSerial
    test('to test the property `sourceDeviceSerial`', () async {
      // TODO
    });

    // Target device serial
    // String targetDeviceSerail
    test('to test the property `targetDeviceSerail`', () async {
      // TODO
    });
    ...
    test('to test the property `parameterCode`', () async {
      // TODO
    });

    // Expression that should be evaluated
    // String sourceExpression
    test('to test the property `sourceExpression`', () async {
      // TODO
    });

    // Vendor code of the target device
    // String targetDeviceVendorCode
    test('to test the property `targetDeviceVendorCode`', () async {
      // TODO
    });

    // Vendor code of the source device
    // String sourceDeviceVendorCode
    test('to test the property `sourceDeviceVendorCode`', () async {
      // TODO
    });
  });
}
