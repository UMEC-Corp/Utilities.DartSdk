...
class GoogleRpcStatus {
  ...
  List<GoogleProtobufWellKnownTypesAny> details;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is GoogleRpcStatus &&
          other.code == code &&
  ...
  @override
  String toString() =>
      'GoogleRpcStatus[code=$code, message=$message, details=$details]';
  ...
  static GoogleRpcStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GoogleRpcStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GoogleRpcStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return GoogleRpcStatus(
        ...
        details: GoogleProtobufWellKnownTypesAny.listFromJson(json[r'details']),
      );
    }
    return null;
  }

  static List<GoogleRpcStatus> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GoogleRpcStatus>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GoogleRpcStatus.listFromJson(
          entry.value,
          growable: growable,
        );
      }
