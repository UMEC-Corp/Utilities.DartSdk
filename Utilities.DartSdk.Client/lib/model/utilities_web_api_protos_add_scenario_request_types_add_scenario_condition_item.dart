...
class UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem {
  /// Returns a new [UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem] instance.
  ...
  /// Code of the sensor to check value
  ///
  /// Please note: This property should have been non-nullable! Since the specification file
  /// does not include a default value (using the "default:" property), however, the generated
  /// source code must fall back to having a nullable type.
  ...
  bool operator ==(Object other) =>
      ...
      other is UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem &&
          other.index == index &&
  ...
  /// Returns a new [UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  // maps a json object with a list of UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem-objects as value to a dart map
  static Map<
          String,
          List<
              UtilitiesWebApiProtosAddScenarioRequestTypesAddScenarioConditionItem>>
