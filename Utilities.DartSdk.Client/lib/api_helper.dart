...
String parameterToString(dynamic value) {
  ...
  if (value is UtilitiesWebApiProtosContactType) {
    return UtilitiesWebApiProtosContactTypeTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosDashboardDisplayMode) {
    return UtilitiesWebApiProtosDashboardDisplayModeTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosEventClass) {
    return UtilitiesWebApiProtosEventClassTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosImportance) {
    return UtilitiesWebApiProtosImportanceTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosScenarioActionType) {
    return UtilitiesWebApiProtosScenarioActionTypeTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosScenarioConditionOperation) {
    return UtilitiesWebApiProtosScenarioConditionOperationTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosScenarioConditionType) {
    return UtilitiesWebApiProtosScenarioConditionTypeTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosScenarioRunStatus) {
    return UtilitiesWebApiProtosScenarioRunStatusTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosScenarioValueType) {
    return UtilitiesWebApiProtosScenarioValueTypeTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosUnitStatus) {
    return UtilitiesWebApiProtosUnitStatusTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is UtilitiesWebApiProtosUserRole) {
    return UtilitiesWebApiProtosUserRoleTypeTransformer()
        .encode(value)
        .toString();
  }
