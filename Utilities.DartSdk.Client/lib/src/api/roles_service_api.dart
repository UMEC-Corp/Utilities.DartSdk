...
class RolesServiceApi {
  ...
  const RolesServiceApi(this._dio, this._serializers);
  ...
  apiDashboardV1RolesGet({
    ...
    UtilitiesWebApiProtosListRolesResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosListRolesResponse>(
      data: _responseData,
