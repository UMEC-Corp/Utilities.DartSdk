...
class ModelsServiceApi {
  ...
  Future<Response<UtilitiesWebApiProtosGetDeviceModelDetailsResponse>>
    ...
    final _path = r'/api/dashboard/v1/models/{modelId}'.replaceAll(
        '{' r'modelId' '}',
        encodeQueryParameter(_serializers, modelId, const FullType(int))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  Future<Response<UtilitiesWebApiProtosListDeviceModelsResponse>>
    ...
    try {
      ...
      _bodyData = utilitiesWebApiProtosListDeviceModelsRequest == null
          ? null
          : _serializers.serialize(utilitiesWebApiProtosListDeviceModelsRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(UtilitiesWebApiProtosListDeviceModelsResponse),
