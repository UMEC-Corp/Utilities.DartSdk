...
class AddressesServiceApi {
  ...
  const AddressesServiceApi(this._dio, this._serializers);

  /// Get detailed info on a specific Address
  ///
  ///
  /// Parameters:
  /// * [addressId] - Id of the address to get
  ...
  apiDashboardV1AddressesAddressIdGet({
    ...
    UtilitiesWebApiProtosGetAddressDetailsResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosGetAddressDetailsResponse>(
      data: _responseData,
  ...
  apiDashboardV1AddressesGet({
    ...
    UtilitiesWebApiProtosListAddressesResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosListAddressesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - id of the address being removed
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> apiDashboardV1AddressesIdDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  apiDashboardV1AddressesPost({
    ...
    UtilitiesWebApiProtosAddAddressResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosAddAddressResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
