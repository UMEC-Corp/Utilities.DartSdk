...
class DeviceGroupsServiceApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UtilitiesWebApiProtosListGroupAlertsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UtilitiesWebApiProtosListGroupAlertsResponse>>
  apiDashboardV1DeviceGroupsGroupIdAlertsGet({
    ...
    final _path = r'/api/dashboard/v1/device-groups/{groupId}/alerts'
        .replaceAll(
          '{'
          r'groupId'
          '}',
    ...
    UtilitiesWebApiProtosListGroupAlertsResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                ...
                as UtilitiesWebApiProtosListGroupAlertsResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UtilitiesWebApiProtosListGroupAlertsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JsonObject>> apiDashboardV1DeviceGroupsGroupIdDelete({
    ...
    final _queryParameters = <String, dynamic>{
      if (strategy != null)
        r'strategy': encodeQueryParameter(
          _serializers,
          strategy,
  ...
  apiDashboardV1DeviceGroupssubtreeGet({
    ...
    final _queryParameters = <String, dynamic>{
      if (groupId != null)
        r'groupId': encodeQueryParameter(
          _serializers,
          groupId,
          const FullType(String),
        ),
