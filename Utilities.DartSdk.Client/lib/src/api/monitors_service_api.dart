...
class MonitorsServiceApi {
  ...
  apiDashboardV1UnitsUnitIdMonitorsGet({
    ...
    UtilitiesWebApiProtosListMonitorsResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosListMonitorsResponse>(
      data: _responseData,
  ...
  apiDashboardV1UnitsUnitIdMonitorsMonitorIdGet({
    ...
    UtilitiesWebApiProtosGetMonitorResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosGetMonitorResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> apiDashboardV1UnitsUnitIdMonitorsMonitorIdPut({
    required String unitId,
    required int monitorId,
    UtilitiesWebApiProtosUpdateMonitorRequest?
    utilitiesWebApiProtosUpdateMonitorRequest,
  ...
  apiDashboardV1UnitsUnitIdMonitorsPost({
    ...
    UtilitiesWebApiProtosAddMonitorResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosAddMonitorResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
