...
class StreamsServiceApi {
  ...
  const StreamsServiceApi(this._dio, this._serializers);
  ...
  Future<Response<UtilitiesWebApiProtosUnitEventsResponse>>
    ...
    UtilitiesWebApiProtosUnitEventsResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosUnitEventsResponse>(
      data: _responseData,
  ...
  Future<Response<UtilitiesWebApiProtosUnitEventsResponse>>
    ...
    final _queryParameters = <String, dynamic>{
      if (unitIds != null)
        r'unitIds': encodeCollectionQueryParameter<String>(
          _serializers,
          unitIds,
