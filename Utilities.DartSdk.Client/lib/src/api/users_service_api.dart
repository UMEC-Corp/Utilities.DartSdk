...
class UsersServiceApi {
  ...
  const UsersServiceApi(this._dio, this._serializers);
  ...
  Future<Response<UtilitiesWebApiProtosConfirmOtpResponse>>
    ...
    UtilitiesWebApiProtosConfirmOtpResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosConfirmOtpResponse>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [userName] - Name of the user who should get available auth method
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<UtilitiesWebApiProtosGetAuthMethodResponse>>
    ...
    UtilitiesWebApiProtosGetAuthMethodResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosGetAuthMethodResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UtilitiesWebApiProtosRefreshTokenResponse>>
    ...
    UtilitiesWebApiProtosRefreshTokenResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosRefreshTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [utilitiesWebApiProtosRequestPasswordResetRequest] - The request received from the client.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<JsonObject>> apiDashboardV1AuthRequestPasswordResetPost({
    ...
    try {
      const _type = FullType(UtilitiesWebApiProtosRequestPasswordResetRequest);
      _bodyData = utilitiesWebApiProtosRequestPasswordResetRequest == null
          ? null
  ...
  ///
  /// Parameters:
  /// * [utilitiesWebApiProtosResetPasswordRequest] - The request received from the client.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<UtilitiesWebApiProtosSignInResponse>>
    ...
    UtilitiesWebApiProtosSignInResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosSignInResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> apiDashboardV1AuthSignOutPost({
    JsonObject? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
