...
class MaintainersServiceApi {
  ...
  const MaintainersServiceApi(this._dio, this._serializers);
  ...
  Future<Response<UtilitiesWebApiProtosGetMaintainerResponse>>
    ...
    UtilitiesWebApiProtosGetMaintainerResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosGetMaintainerResponse>(
      data: _responseData,
  ...
  Future<Response<UtilitiesWebApiProtosAddMaintainerResponse>>
    ...
    UtilitiesWebApiProtosAddMaintainerResponse? _responseData;
    ...
    return Response<UtilitiesWebApiProtosAddMaintainerResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [utilitiesWebApiProtosUpdateMaintainerRequest] - The request received from the client.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
